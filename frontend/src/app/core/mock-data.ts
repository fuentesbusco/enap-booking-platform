import { Space, Booking, Announcement, User } from './models';
...
export const MOCK_BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    user: { id: 2, full_name: 'Ana González', rut: '15.678.901-2', email: 'ana@gmail.com', role: 'external' },
    space: MOCK_SPACES[3],
    check_in: '2025-12-28',
  ...
  },
  {
    ...
    total_amount: 187000,
    guests: [
      { id: 9, full_name: 'Isabel Muñoz', rut: '23.456.789-0' },
      { id: 10, full_name: 'Diego Muñoz', rut: '24.567.890-1' },
      { id: 11, full_name: 'Valentina Rojas', rut: '25.678.901-2' },
    ],
    created_at: '2025-12-08T16:00:00',
    price_breakdown: { base: 180000, days: 4, guests_count: 3, guests_total: 10500, free_guests_applied: 0, discount: 0, total: 190500 },
  },
];

// Fechas bloqueadas por espacio (formato YYYY-MM-DD)
