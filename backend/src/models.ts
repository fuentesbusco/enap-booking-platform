...
export const MOCK_SPACES: Space[] = [
  ...
  },
  {
    ...
    type: 'pool',
    description: 'Piscina principal del centro vacacional con área de sol y zona de niños. Los socios incluyen 5 invitados sin costo adicional. Capacidad máxima total de 80 personas.',
    max_capacity: 80,
    base_price: 5000,
    socio_price: 0,
    guest_price: 3500,
...
export const MOCK_BOOKINGS: Booking[] = [
  {
    ...
    assigned_unit: 'Cabaña 1',
  },
  {
    id: 2,
    booking_code: 'ENP-2025-00002',
    user: MOCK_USER_EXTERNAL,
    space: MOCK_SPACES[1], // Quinchos Familiares
    check_in: '2025-12-28',
  ...
  },
  {
    ...
    space: MOCK_SPACES[2], // Piscina General
    check_in: '2026-01-05',
