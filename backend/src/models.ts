...
export const MOCK_SPACES: Space[] = [
  {
    ...
    name: 'Cabaña 1',
    type: 'cabin',
    description: 'Cabaña equipada para 6 personas con menaje, servicios, juegos de batería, cocina, refrigerador, hornos, juguera, secador de pelo, televisión satelital e Internet controlado, dos camarotes y una cama matrimonial.',
    max_capacity: 6,
    base_price: 50000,
    socio_price: 35000,
    guest_price: 3500,
  ...
  },
  {
    ...
    name: 'Quincho 1',
    type: 'quincho',
    description: 'Quincho equipado con parrilla, mesas y sillas para asados y celebraciones al aire libre.',
    max_capacity: 30,
    base_price: 45000,
    socio_price: 30000,
    guest_price: 3500,
...
export const MOCK_BOOKINGS: Booking[] = [
  ...
  },
  {
    ...
    space: MOCK_SPACES[6], // Quincho Central
    check_in: '2025-12-28',
  ...
  },
  {
    ...
    space: MOCK_SPACES[8], // Piscina General
    check_in: '2026-01-05',
...
export const BLOCKED_DATES: Record<number, string[]> = {
  ...
  5: [],
  6: [],
  7: ['2025-12-10', '2025-12-11', '2025-12-28'],
  8: ['2025-12-31'],
  9: ['2026-01-05'],
};
