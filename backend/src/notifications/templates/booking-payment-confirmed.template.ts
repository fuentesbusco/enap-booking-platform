...
export function getBookingPaymentConfirmedEmailTemplate(booking: Booking): string {
...
<head>
  ...
  <title>Confirmación de Pago y Reserva Aprobada - Sindicato ENAP</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 40px 30px 40px;">
              <div style="text-align: center; margin-bottom: 24px;">
                <span style="background-color: #E8F5E9; color: #2E7D32; padding: 8px 16px; border-radius: 20px; font-size: 13px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px;">Pago Aprobado • Reserva Confirmada</span>
              </div>
              <h2 style="margin: 0 0 16px 0; font-family: 'Playfair Display', 'Georgia', serif; font-size: 22px; color: #1A1A2E; font-weight: normal; text-align: center;">¡Hola ${user.fullName}!</h2>
              <p style="margin: 0 0 24px 0; font-size: 15px; color: #52796F; line-height: 1.6; text-align: center;">
                Te informamos que tu comprobante de pago ha sido revisado y <strong>aprobado con éxito</strong>. Tu estadía ha sido confirmada y asegurada en el sistema.
              </p>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #F0F4F1; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
                ...
                <tr>
                  <td style="padding: 6px 0; font-size: 14px; color: #52796F;">Fechas de Estadía:</td>
                ...
                <tr>
                  <td style="padding: 6px 0; font-size: 14px; color: #52796F;">Estado de Pago:</td>
                  <td style="padding: 6px 0; font-size: 14px; font-weight: bold; color: #2E7D32; text-align: right;">Pagado (${formatCLP(breakdown.total)})</td>
                </tr>
              </table>

              <!-- Detailed breakdown -->
              <h3 style="margin: 28px 0 12px 0; font-size: 14px; color: #1B4332; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; font-family: monospace;">Valores Detallados</h3>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 28px; border-collapse: collapse;">
                ...
                <tr>
                  <td style="padding: 16px 0; color: #1B4332; font-size: 16px; font-weight: bold;">Monto total cancelado:</td>
                  <td style="padding: 16px 0; color: #1B4332; text-align: right; font-size: 20px; font-weight: bold;">${formatCLP(breakdown.total)}</td>
                </tr>
              </table>

              <!-- Guests Section -->
              <h3 style="margin: 24px 0 12px 0; font-size: 14px; color: #1B4332; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; font-family: monospace;">Acompañantes Autorizados</h3>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 32px; border-collapse: collapse;">
                ${guestsListHtml}
              </table>

              <!-- Check-in & Rules highlight box -->
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border: 1px solid rgba(82, 121, 111, 0.2); border-left: 4px solid #1B4332; background-color: #FAFCFA; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                <tr>
                  <td colspan="2" style="font-size: 11px; font-weight: bold; color: #1B4332; text-transform: uppercase; font-family: monospace; letter-spacing: 1.5px; padding-bottom: 12px; border-bottom: 1px solid rgba(27, 67, 50, 0.08);">Información Importante de Ingreso</td>
                </tr>
                <tr>
                  <td style="padding: 10px 0 5px 0; font-size: 14px; color: #52796F; font-weight: bold; width: 120px;">Horario de Ingreso:</td>
                  <td style="padding: 10px 0 5px 0; font-size: 14px; color: #1A1A2E;">Check-in desde las 15:00 hrs.</td>
                </tr>
                <tr>
                  <td style="padding: 5px 0; font-size: 14px; color: #52796F; font-weight: bold;">Horario de Salida:</td>
                  <td style="padding: 5px 0; font-size: 14px; color: #1A1A2E;">Check-out hasta las 12:00 hrs.</td>
                </tr>
                <tr>
                  <td style="padding: 5px 0; font-size: 14px; color: #52796F; font-weight: bold; vertical-align: top;">Requisitos de Acceso:</td>
                  <td style="padding: 5px 0; font-size: 14px; color: #1A1A2E; line-height: 1.4;">Presentar Cédula de Identidad de todos los asistentes en portería e indicar el Código de Reserva <strong>${booking.bookingCode}</strong>.</td>
                </tr>
                <tr>
                  <td style="padding: 5px 0 10px 0; font-size: 14px; color: #52796F; font-weight: bold; vertical-align: top;">Reglamento:</td>
                  <td style="padding: 5px 0 10px 0; font-size: 14px; color: #1A1A2E; line-height: 1.4;">Cuidar el entorno, apagar fogatas en áreas autorizadas y respetar la capacidad máxima del recinto (${space.maxCapacity} personas).</td>
                </tr>
              </table>

              <!-- CTA / Instructions -->
              <p style="margin: 0 0 24px 0; font-size: 14px; color: #52796F; line-height: 1.5; text-align: center;">
                ¡Esperamos que disfrutes de tu estadía! Si tienes alguna duda, puedes contactarnos a través de los canales del Sindicato.
              </p>
            </td>
          </tr>
